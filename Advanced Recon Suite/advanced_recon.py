...
def get_args():
    parser = argparse.ArgumentParser(description="Advanced Recon Automation Tool")
    ...
    parser.add_argument("--wafw00f", action="store_true", help="Get Web Applicatin Firewalls")
...
def main():
    ...
    if args.wafw00f:
        print("Capturing Web Application Firewalls....\n")
        report["security"] = {"waf": detect_waf(domain)}

    if args.cdn:
        print("Capturing CDN services....\n")
        report['CDN']={"CDN ": detect_cdn(domain)}
